...
Like many things, the following is a personal flavour.. The necessary build options are kept in an separate file called RFM69.mak, kept in the same folder as the Makefile. I then add the following line to the end of the Makefile:  
